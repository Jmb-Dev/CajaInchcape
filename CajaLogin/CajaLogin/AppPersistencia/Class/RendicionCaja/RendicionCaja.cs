...
namespace CajaIndu.AppPersistencia.Class.RendicionCaja
{
    class RendicionCaja
    {
                ...
                if (string.IsNullOrEmpty(retval))
                {
                    ...
                    try
                    {
                        for (int i = 0; i < lt_DETALLE_VP.Count(); i++)
                        {
                            ...
                            {
                                //string Valor = lt_DETALLE_VP[i].GetString("MONTO").Trim();
                                //if (Valor.Contains("-"))
                                //{
                                //    Valor = "-" + Valor.Replace("-", "");
                                //}
                    ...
                    try
                    {
                        for (int i = 0; i < lt_RESUMEN_VP.Count(); i++)
                        {
                            ...
                            if (lt_RESUMEN_VP.GetString("VIA_PAGO") == "N")
                            {
                            ...
                            {
                                //string Valor = lt_RESUMEN_VP[i].GetString("MONTO").Trim();
                                //if (Valor.Contains("-"))
                                //{
                                //    Valor = "-" + Valor.Replace("-", "");
                                //}
                                ...
                                //decimal ValorAux = Convert.ToDecimal(Valor);
                                //string Cualquiernombre = string.Format("{0:0,0}", ValorAux);
                                //resumenvp.MONTO = Cualquiernombre;
                                resumenvp.MONTO = FM.FormatoMonedaChilena(lt_RESUMEN_VP[i].GetString("MONTO"),  "1");
                            }
                            else
                            {
                                //string moneda = Convert.ToString(lt_RESUMEN_VP[i].GetString("MONTO"));
                                //decimal ValorAux = Convert.ToDecimal(moneda);
                                //resumenvp.MONTO = string.Format("{0:0,0.##}", ValorAux);
                    ...
                    try
                    {
                        for (int i = 0; i < lt_DETALLE_REND.Count(); i++)
                        {
                            ...
                            else
                            {
                                ...
                                MontoEfect = MontoEfect + Convert.ToDouble(detallerend.MONTO_EFEC);
                    ...
                    try
                    {
                        for (int i = 0; i < lt_DET_ARQUEO.Count(); i++)
                        {
                            ...
                            //detallearqueo.SUMA_MON_BILL = lt_DET_ARQUEO.GetString("SUMA_MON_BILL");
                            if (lt_DET_ARQUEO[i].GetString("MONEDA") == "CLP")
                            {
                            ...
                            //detallearqueo.CANTIDAD_DOC = lt_DET_ARQUEO.GetString("CANTIDAD_DOC");
                             ...
                             if (lt_DET_ARQUEO.GetString("TIPO_MONEDA") == "0000000005")
                            {
                                ...
                                //M5 = lt_DET_ARQUEO.GetString("SUMA_MON_BILL");
                             }
