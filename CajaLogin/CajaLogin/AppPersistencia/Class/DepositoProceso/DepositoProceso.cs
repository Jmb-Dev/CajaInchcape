...
using CajaIndu.AppPersistencia.Class.DepositoProceso.Estructura;

namespace CajaIndu.AppPersistencia.Class.DepositoProceso
{
    class DepositoProceso
    {
        ...
        public List<CajaIndu.AppPersistencia.Class.DepositoProceso.Estructura.RETORNO> Retorno = new List<CajaIndu.AppPersistencia.Class.DepositoProceso.Estructura.RETORNO>();
